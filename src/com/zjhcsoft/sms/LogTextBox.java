...
public class LogTextBox extends TextView {
	...
	public void appendLog(CharSequence text) {
		
		String now = TimeConvert.getCurrTime();
		text = "\r\n" +now + ": " +text;
		super.append(text);
		final TextView tv = this;
		final Layout layout = tv.getLayout();

		int curLines = tv.getLineCount();
		if(tv.getLineCount()> maxLines){
			tv.getEditableText().delete(0, curLines - 1000);
		}
