...
public class SmsDownloadService2  extends WakefulIntentService {
...
//    private Intent broadIntent = new Intent(BROAD_UPDATE);
    ...
    private static SmsDownloadService2 sInstance;
    
    public SmsDownloadService2() {
    	super("SmsDownloadService2");
	}

	public static SmsDownloadService2 getInstance(){
    	return sInstance;
    }
...
//        sendBroadcast(broadIntent);  
        ...
        LogHelper.msg(SmsDownloadService2.this, BROAD_UPDATE, new String[]{KEY_MSG_SERVICE_READY}, new String[]{"1"});
    }
	...
	public class LocalBinder extends Binder {
    	SmsDownloadService2 getService() {
            return SmsDownloadService2.this;
        }
    }
...
//        sendBroadcast(broadIntent);  
        LogHelper.msg(SmsDownloadService2.this, BROAD_UPDATE, new String[]{KEY_MSG_AREA}, new String[]{ mArea });
			...
			public void run(){    
			 // 在此处添加执行的代码    
				try {
					...
					LogHelper.exception(SmsDownloadService2.this, "下载异常：",e);
//					timer.cancel();
//					e.printStackTrace();
				}
			}    
...
//        sendBroadcast(broadIntent); 
        LogHelper.msg(SmsDownloadService2.this, SmsDownloadService2.BROAD_UPDATE, new String[]{key}, new String[]{String.valueOf(content) });
    }
...
//    			SmsManager sms0 = SmsManager.getDefault();   
    			...
    			db = new DBHelper(SmsDownloadService2.this);
    			for(int i=0; i<num; i++){
...
//    					Thread.sleep(m_interval_send);
    			...
    			LogHelper.msg(SmsDownloadService2.this, SmsDownloadService2.KEY_MSG_TASK_ARRIVAL, new String[]{"rows"}, new String[]{String.valueOf(mCountSend) });
